...
var t = this.$.reorderContainer.hasNode().style, n = parseInt(t.left) + e.ddx, r = this.getScrollTop() - this.prevScrollTop, i = parseInt(t.top) + parseInt(e.ddy) + r;
this.$.reorderContainer.addStyles("top: " + i + "px ; left: " + n + "px"), this.prevScrollTop = this.getScrollTop();
},
checkForAutoScroll: function(e) {
var t = this.getNodePosition(this.hasNode()), n = this.getBounds();
if (e.pageY - t.top < n.height * this.dragToScrollThreshold) {
var r = 100 * (1 - (e.pageY - t.top) / (n.height * this.dragToScrollThreshold));
this.scrollDistance = -1 * r;
} else if (e.pageY - t.top > n.height * (1 - this.dragToScrollThreshold)) {
var r = 100 * ((e.pageY - t.top - n.height * (1 - this.dragToScrollThreshold)) / (n.height - n.height * (1 - this.dragToScrollThreshold)));
this.scrollDistance = 1 * r;
} else this.scrollDistance = 0;
this.scrollDistance == 0 ? this.stopAutoScrolling() : this.autoScrollTimeout || this.startAutoScrolling();
},
...
var e = Math.min(this.draggingRowIndex, this.placeholderRowIndex), t = Math.max(this.draggingRowIndex, this.placeholderRowIndex), n = this.draggingRowIndex - this.placeholderRowIndex > 0 ? 1 : -1, r;
if (n === 1) {
r = this.$.generator.fetchRowNode(this.draggingRowIndex), r.setAttribute("data-enyo-index", "reordered");
for (var i = t - 1, s = t; i >= e; i--) {
var r = this.$.generator.fetchRowNode(i);
if (!r) {
enyo.log("No node - " + i);
continue;
}
var o = parseInt(r.getAttribute("data-enyo-index"));
s = o + 1, r.setAttribute("data-enyo-index", s);
}
...
var e = this.currentPage == 1 ? 0 : 1;
if (this.initialPageNumber < this.currentPageNumber) {
var t = this.$["page" + this.currentPage].hasNode().firstChild;
this.$["page" + e].hasNode().appendChild(t);
} else {
var t = this.$["page" + this.currentPage].hasNode().lastChild, n = this.$["page" + e].hasNode().firstChild;
this.$["page" + e].hasNode().insertBefore(t, n);
}
this.pageHeights[this.initialPageNumber] = this.getPageHeight(this.initialPageNumber) + this.rowHeight, this.pageHeights[this.currentPageNumber] = this.getPageHeight(this.currentPageNumber) - this.rowHeight, this.updatePagePositions(this.initialPageNumber, e);
},
hideNode: function(e) {
...
var i, s, o, u = [], a;
if (t.length > 0 && n) for (a = t.length; a > 0; a--) o = t.slice(0, a), i = o.join(r ? "" : " "), s = i.toLowerCase(), s = s.replace(/[,\.]/g, ""), s in n && (u = u.concat(r ? i : o), t = t.slice(a), a = t.length + 1);
return u;
},
...
if (o.length > 1) for (u = o.length; u > 0; u--) {
...
if (o.length > 1) for (u = o.length; u > 0; u--) c = o.slice(-u), h = c.join(d ? "" : " "), p = h.toLowerCase(), p = p.replace(/[,\.]/g, ""), i.suffixes && enyo.indexOf(p, i.suffixes) > -1 && (this.suffix ? (d || (this.suffix = " " + this.suffix), this.suffix = h + this.suffix) : this.suffix = h, o = o.slice(0, o.length - u), u = o.length);
...
var n, r, i, s, o;
if (t.auxillaries && (e.length > 2 || this.prefix)) for (n = 0; n < e.length - 1; n++) for (r = e.length; r > n; r--) i = e.slice(n, r), s = i.join(" "), o = s.toLowerCase(), o = o.replace(/[,\.]/g, ""), o in t.auxillaries && (e.splice(n, r + 1 - n, i.concat(e[r])), r = n);
return e;
},
...
var t, n;
t = [];
if (this.styles) for (n in this.styles) this.styles[n].example && t.push({
key: n,
...
} else if (this.countryCode !== e.countryCode) if (e.countryCode === "33" || this.countryCode === "33") if (this.countryCode in n || e.countryCode in n) {
if (this.areaCode !== e.areaCode || this.mobilePrefix !== e.mobilePrefix) t -= 100;
} else t -= 100; else this.countryCode === "39" || e.countryCode === "39" ? this.countryCode in r || e.countryCode in r ? this.areaCode !== e.areaCode && (t -= 100) : t -= 100 : t -= 100;
...
for (n in t) if (n !== undefined && this[n] !== undefined && typeof this[n] != "object") {
...
for (n in t) if (n !== undefined && t[n] !== undefined && typeof t[n] != "object") {
...
if (o.subscriberNumber && (!e.manualDialing || o.iddPrefix || o.countryCode || o.trunkAccess)) if (l.region !== c.region) !o._hasPrefix() && e.defaultAreaCode && c.region === f.region && (!n.fieldLengths.minLocalLength || o.subscriberNumber.length >= n.fieldLengths.minLocalLength) && (o.areaCode = e.defaultAreaCode, !n.skipTrunk && n.trunkCode && (o.trunkAccess = n.trunkCode)), o.trunkAccess && n.skipTrunk && delete o.trunkAccess, e.sms ? f.region === "us" && l.region !== "us" ? c.region !== "us" ? (o.iddPrefix = "011", o.countryCode = o.countryCode || enyo.g11n.PhoneUtils.mapRegiontoCC(c.region)) : e.networkType === "cdma" ? (delete o.iddPrefix, delete o.countryCode, o.areaCode && (o.trunkAccess = "1")) : o.areaCode && (o.iddPrefix = "+", o.countryCode = "1", delete o.trunkAccess) : (o.iddPrefix = e.networkType === "cdma" ? t.iddCode : "+", o.countryCode = o.countryCode || enyo.g11n.PhoneUtils.mapRegiontoCC(c.region)) : o._hasPrefix() && !o.countryCode && (o.countryCode = enyo.g11n.PhoneUtils.mapRegiontoCC(c.region)), o.countryCode && !e.sms && (o.iddPrefix = e.networkType === "cdma" ? t.iddCode : "+"); else {
...
if (e.sms && f.region === "us" && l.region !== "us") o.iddPrefix = "011", n.skipTrunk && o.trunkAccess && delete o.trunkAccess; else if (o.iddPrefix || o.countryCode) delete o.iddPrefix, delete o.countryCode, (n.dialingPlan === "open" || n.trunkRequired) && n.trunkCode && (o.trunkAccess = n.trunkCode);
}
...
var r, i, s = [], o;
if (n[t]) return n[t];
for (o in n) if (o && typeof o == "string") {
r = 0, i = !1;
...
if (c !== undefined) if (f.extendedAreaCodes) {
...
var n = this.filter ? this.filtered : this.db, r = enyo.clone(n[t.reorderFrom]);
n.splice(t.reorderFrom, 1), n.splice(t.reorderTo, 0, r), this.log("from: " + t.reorderFrom + ", to: " + t.reorderTo);
},
rendered: function() {
this.inherited(arguments), this.populateList();
},
...
if (n == "" || isNaN(n)) return;
this.$.carousel.setIndex(parseInt(n));
},
...
for (var r = 0; r < n.length; r++) if (n[r].name == "sourceViewer") {
...
this.cssSource = t;
var n = this.getComponents();
for (var r = 0, i = !1; r < n.length; r++) if (n[r].name == "sourceViewer") {
...
for (var t = 0; t < e.length; t++) if (e[t].name == "sourceViewer") {
...
style: "float:right; position:relative; right: 5px; top:5px;"
}, {
kind: "onyx.Toolbar",
